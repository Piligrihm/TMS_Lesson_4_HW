...
public class StringToMyFormat {
     ...
     */
    public static void checkCharSequence(String str, String charSequence) {
        String result = "";
        if (isValid(str)) {
            ...
            if (str.contains(charSequence)) {
                ...
                result = "Последовательность - " + charSequence + " - в строке не присутствует";
            }
        }
        System.out.println(result);
    }
    ...
    /**
     * Метод позаоляет проверить, является ли заданная последовательность символов началом строки
     *
     * @param str          - строка, принимаемая на вход
     * @param charSequence - последовательность символов, принимаемая на вход
     * @return возвращает строку
     */
    public static void checkStringStart(String str, String charSequence) {
        String result = "";
        if (isValid(str)) {
            charSequence = charSequence.toLowerCase();
            str = str.toLowerCase();
            if (str.startsWith(charSequence)) {
                ...
                result = "Последовательность - " + charSequence + " - не является началом строки";
            }
        }
        System.out.println(result);
    }
     ...
     * @return возвращает строку
     */
    public static void checkStringEnd(String str, String charSequence) {
        String result = "";
        if (isValid(str)) {
            charSequence = charSequence.toLowerCase();
            str = str.toLowerCase();
            if (str.startsWith(charSequence)) {
                ...
                result = "Последовательность - " + charSequence + " - не является окончанием строки";
            }
        }
        System.out.println(result);
    }
